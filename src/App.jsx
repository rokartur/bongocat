            ...
            <div className="picker">
              ...
              <h6>Made with ❤️ by <a id="credits" href="https://discord.com/users/432622667787665419" target="_blank">arwat</a>️</h6>
                <span className="footer_span">
                  ...
                  <br/>
                  <a href="https://discord.gg/2fjtBMPHuZ" id="link" target="_blank">
                      <svg id="footer_logo" width="38" height="29" fill="white" viewBox="0 0 38 29"  xmlns="http://www.w3.org/2000/svg">
